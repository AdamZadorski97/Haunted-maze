...
public class CoinOculusion : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (m_CullingGroup == null)
        {
            ...
            m_CullingGroup.SetBoundingSpheres(new[] { new BoundingSphere(floorController.interactivePoint.transform.position, cullingRadius) });
    ...
    private void OnDrawGizmosSelected()
    {
        if (enabled)
        {
            ...
            Gizmos.color = col;
            Gizmos.DrawWireSphere(floorController.interactivePoint.transform.position, cullingRadius);
        }
    }
}
